...
VALUES ('101 BEECH AVENUE', 'NORTHAMPTON', 'UK'),
	('566 Creeds Avenue', 'Texas', 'USA'),
	('123 Sun WAY', 'SAN FERNANDO', 'USA'),
	('852 UNI DRIVE', 'SAN DIEGO', 'USA'),
	('456 COVO STREET', 'LUTON', 'UK'),
	('056 TIME SQUARE', 'NEW YORK', 'USA'),
	('111 HUMBERG STREET', 'COLORADO', 'UK'),
	('963 SANINT AVE', 'SAN DIEGO', 'USA'),
	('152 KETTERING ROAD', 'NORTHAMPTON', 'UK'),
	('33 CASTLE ASBY', 'NORTHAMPTON', 'UK');
...
VALUES (seq_ambassador_id.NEXTVAL, 'RITESH', 'SHAH', 'M', '64SH5AHRITESHJUNG6533@GMAIL.COM', seq_ambassador_id.CURRVAL, 979.66 ,contact_detail_varray_type(contact_detail_type('0743456456', 'MOBILE') ,contact_detail_type('07543456456', 'HOME')) ,address_type('101 BEECH AVENUE', 'NORTHAMPTON', 'UK')),
	('HAPPY', 'APPLE', 'F', 'HAPPYAPPLE@GMAIL.COM', 10000.50 ,'7412365895', 'MOBILE' ,'8520369874', 'HOME','566 Creeds Avenue', 'Texas', 'USA'),
('SAD', 'MANGO', 'M', 'SADMANGO@GMAIL.COM', 15000.00 ,'7894561230', 'MOBILE' ,'9632587412', 'HOME','123 Sun WAY', 'SAN FERNANDO', 'USA'),
('CALM', 'BANANA', 'M', 'CALMBANANA@GMAIL.COM', 20000.50 ,'7532148920', 'MOBILE' ,'9856325015', 'HOME','852 UNI DRIVE', 'SAN DIEGO', 'USA'),
('RUDE', 'GUAVA', 'F', 'RUDEGUAVA@GMAIL.COM', 20099.99 ,'7391468202', 'MOBILE' ,'9856230145', 'HOME','111 HUMBERG STREET', 'COLORADO', 'UK'),
('LOVELY', 'BERRY', 'M', 'LOVELYBERRY@GMAIL.COM', 35000.00 ,'7897897890', 'MOBILE' ,'8894521035', 'HOME','152 KETTERING ROAD', 'NORTHAMPTON', 'UK'),
('BORED', 'MANGO', 'M', 'BOREDMANGO@GMAIL.COM', 40000.00 ,'7414118520', 'MOBILE' ,'8426795130', 'HOME','33 CASTLE ASBY', 'NORTHAMPTON', 'UK');
...
VALUES (seq_experience_nature_id.NEXTVAL, 'HIKING', 'PHYSICAL AND OUTDOOR'),
	('CONCERT', 'MUSIC AND 2021 RAVE'),
	('BINGO', 'OLD PEOPLES GAME'),
	('DANCE AND DRINK', 'YOUTH RNB DANCE'),
	('KIDS FESTIVAL', 'KIDS AND FAMILY OUTDOORS');
...
-- (1200, 20500, '111 HUMBERG STREET'),
-- (500, 5500, '852 UNI DRIVE'),
-- (750, 2500, '056 TIME SQUARE'),
-- (200, 1000, '33 CASTLE ASBY');
...
VALUES (1, 1, 'HIKING','CARDIO', 5000 ),
	(2, 1, 'BINGO','CLASSIC', 50 ),
	(3, 2, 'DANCE','RAVE', 50 ),
	(4, 4, 'BUNGEE','OUTDOOR', 200 ),
	(5, 3, 'SKY DIVING','OUTDOOR', 500 );
